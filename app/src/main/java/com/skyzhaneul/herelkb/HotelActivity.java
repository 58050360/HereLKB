...
public class HotelActivity extends AppCompatActivity implements MyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleview_hotel);
    ...
    private void searchhotels() {
        Query query = databaseReference.orderByChild("category").equalTo("hotels");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    myAdapter.setOnItemClickListener(HotelActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuLogout:
                ...
                break;
            case R.id.menuHome:
                Intent intent1 = new Intent(HotelActivity.this, MainActivity.class);
