...
public class ProfileActivity extends AppCompatActivity implements MyAdapter_pr.OnItemClickListener {
    ...
    private void search() {
        Query query = databaseReference.orderByChild("pr_user").equalTo(data);
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    myAdapter_pr.setOnItemClickListener(ProfileActivity.this);
    ...
    public void OnItemClick(int position) {
        Intent detailIntent = new Intent(this,EditDeleteActivity.class);
