...
public class PlaceActivity extends AppCompatActivity implements MyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleview_place);
    ...
    private void searchplaces() {
        Query query = databaseReference.orderByChild("category").equalTo("places");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    myAdapter.setOnItemClickListener(PlaceActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuLogout:
                ...
                break;
            case R.id.menuHome:
                Intent intent1 = new Intent(PlaceActivity.this, MainActivity.class);
            ...
            case R.id.menuProfile:
                Intent intent2 = new Intent(PlaceActivity.this, ProfileActivity.class);
